                              ...
                              >
                                <div
                                  ...
                                  style={{
                                    width: 43,
                                    height: 43,
                                    backgroundColor: (_itm.state ? '#30BF24' : '#25B4C1')
                                  }}
                                >
                                  <i className={`fa fa-long-arrow-${_itm.state ? 'up' : 'down'}`} />
                                </div>
                                <div
                                ...
                                >
                                  ...
                                  >
                                    <div>{_itm.state ? 'Send' : 'Receive'}</div>
                                    <div>{_itm.date}</div>
                                  </div>
                                </div>
                              </div>
                    ...
                    <div className="row desk_view desk_view_flex">
                      <div className="col-lg-6 col-md-12 mt-2">
                        ...
                        >
                          ...
                          <span style={{ color: "#a8a8a8" }}>
                            Please Verify the Address and Amount properly.
                          </span>
                          <br />
                          <br />
                          <br />
                        ...
                        /> */}
                          ...
                          <div className="my-4 mx-5">
                            ...
                            <Button
                              style={{ fontWeight: 600, width: "100%", padding: '12px 0' }}
                              className="primary_btnn___ mt-3"
                              variant="primary"
                              type="submit"
                            >
